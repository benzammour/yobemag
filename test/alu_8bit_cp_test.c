...
ParameterizedTest(ALUTestParams *params, CP_A_n, CP_A_n_carry, .init = cpu_mmu_setup, .fini = cpu_teardown) {
...
ParameterizedTest(ALUTestParams *params, CP_A_n, CP_A_n_half_carry, .init = cpu_mmu_setup, .fini = cpu_teardown) {
    alu_emulate_8bit_instruction(params);
}
...
ParameterizedTest(ALUTestParams *params, CP_A_n, CP_A_n_half_carry_and_carry, .init = cpu_mmu_setup,
                  .fini = cpu_teardown) {
    alu_emulate_8bit_instruction(params);
}
...
ParameterizedTest(ALUSpecialTestParams *params, CP_A_n, CP_A_HL_and_d8, .init = cpu_mmu_setup, .fini = cpu_teardown) {
