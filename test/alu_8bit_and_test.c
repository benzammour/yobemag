...
ParameterizedTest(ALUTestParams *params, AND_A_n, AND_A_n_msb, .init = cpu_mmu_setup, .fini = cpu_teardown) {
...
ParameterizedTest(ALUTestParams *params, AND_A_n, AND_A_n_alternating, .init = cpu_mmu_setup, .fini = cpu_teardown) {
    alu_emulate_8bit_instruction(params);
}
...
ParameterizedTest(ALUTestParams *params, AND_A_n, AND_A_n_full, .init = cpu_mmu_setup, .fini = cpu_teardown) {
    alu_emulate_8bit_instruction(params);
}
...
ParameterizedTest(ALUSpecialTestParams *params, AND_A_n, AND_A_HL_and_d8, .init = cpu_mmu_setup, .fini = cpu_teardown) {
